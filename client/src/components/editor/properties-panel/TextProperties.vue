...
import TextBackgroundProperty from './options/TextBackgroundProperty.vue'
  ...
  <div class="flex flex-col gap-5">
        ...
        <div class="flex flex-col gap-1">
          ...
          <InputGroup>
            <NumberInput
              ...
              :max="3"
              class="pl-2"
              @update:model-value="(v) => handleStyleUpdate({ lineHeight: v })"
            />
            <InputGroupAddon align="inline-end">
        ...
        <div class="flex flex-col gap-1">
          ...
          <InputGroup>
            <NumberInput
              ...
              :max="20"
              class="pl-2"
              @update:model-value="(v) => handleStyleUpdate({ letterSpacing: v })"
            />
            <InputGroupAddon align="inline-end">
    ...
    <div class="flex flex-col gap-2 border-t border-border/40 pt-4">
      <TextBackgroundProperty
        ...
        :background-border-radius="style.backgroundBorderRadius"
        :background-padding-x="style.backgroundPaddingX"
        :background-padding-y="style.backgroundPaddingY"
        @background-color-change="(v) => handleStyleUpdate({ backgroundColor: v })"
        @background-opacity-change="(v) => handleStyleUpdate({ backgroundOpacity: v })"
        @background-border-radius-change="(v) => handleStyleUpdate({ backgroundBorderRadius: v })"
        @background-padding-x-change="(v) => handleStyleUpdate({ backgroundPaddingX: v })"
        @background-padding-y-change="(v) => handleStyleUpdate({ backgroundPaddingY: v })"
      />
    </div>
  </div>
</template>
