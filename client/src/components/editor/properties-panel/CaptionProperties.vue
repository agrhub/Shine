...
import { fontManager, jsonToClip, Log } from '@openvideo/engine-pixi';
...
const currentFont = computed(() => 
  getFontByPostScriptName(localState.fontFamily) || (GROUPED_FONTS[0] ? GROUPED_FONTS[0].mainFont : undefined)
);

const currentFamily = computed(() => 
  currentFont.value ? (GROUPED_FONTS.find((f) => f.family === currentFont.value?.family) || GROUPED_FONTS[0]) : GROUPED_FONTS[0]
);
  ...
  <div class="flex flex-col gap-5">
      ...
      <div class="grid grid-cols-2 gap-2">
        <InputGroup>
          ...
          <InputGroupInput
            ...
            @update:model-value="(val: any) => handleUpdate({ left: Number(val) })"
            class="text-sm p-0"
          />
        </InputGroup>
        <InputGroup>
          ...
          <InputGroupInput
            ...
            @update:model-value="(val: any) => handleUpdate({ top: Number(val) })"
            class="text-sm p-0"
          />
        </InputGroup>
      </div>
      <div class="grid grid-cols-2 gap-2">
        <InputGroup>
          ...
          <InputGroupInput
            ...
            @update:model-value="(val: any) => handleUpdate({ width: Number(val) })"
            class="text-sm p-0"
          />
        </InputGroup>
         <InputGroup>
          ...
          <InputGroupInput
            ...
            @update:model-value="(val: any) => handleUpdate({ height: Number(val) })"
            class="text-sm p-0"
          />
        </InputGroup>
      </div>
    ...
    <div class="flex flex-col gap-2">
      ...
      <Select
        ...
        @update:model-value="(val: any) => updateVerticalAlign(String(val || ''))"
      >
    ...
    <div class="flex flex-col gap-2">
      ...
      <Select
        ...
        @update:model-value="(val: any) => changeWordsPerLine(String(val || ''))"
      >
        <SelectTrigger class="w-full h-9">
    ...
    <div class="flex flex-col gap-2">
      ...
      <div class="flex items-center gap-4">
        ...
        <Slider
          ...
          @update:model-value="(val: any) => val?.[0] !== undefined && handleUpdate({ angle: val[0] })"
          :max="360"
          :step="1"
          class="flex-1"
        />
        <InputGroup class="w-20">
          <InputGroupInput
            type="number"
            :model-value="Math.round(localState.angle)"
             @update:model-value="(val: any) => handleUpdate({ angle: Number(val) })"
    ...
    <div class="flex flex-col gap-2">
      ...
      <Select
        ...
        @update:model-value="(val: any) => {
           const family = GROUPED_FONTS.find((f) => f.family === String(val || ''));
      ...
      <div class="grid grid-cols-2 gap-2">
        <Select
          ...
          @update:model-value="(val: any) => handleFontChange(String(val || ''))"
        >
    ...
    <div class="flex flex-col gap-2">
      ...
      <div class="flex items-center gap-4">
        ...
        <Slider
          ...
          @update:model-value="(val: any) => val?.[0] !== undefined && handleUpdate({ opacity: val[0] / 100 })"
          :max="100"
          :step="1"
          class="flex-1"
        />
        <InputGroup class="w-20">
          <InputGroupInput
            type="number"
            :model-value="Math.round(localState.opacity * 100)"
            @update:model-value="(val: any) => handleUpdate({ opacity: Number(val) / 100 })"
            class="text-sm p-0 text-center"
          />
          <InputGroupAddon align="inline-end" class="p-0 pr-2">
             <span class="text-[10px] text-muted-foreground">%</span>
